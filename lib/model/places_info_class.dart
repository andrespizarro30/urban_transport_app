...
class PlacesInfoModel {
  Result? result;
  String? status;

  PlacesInfoModel({this.result, this.status});

  PlacesInfoModel.fromJson(Map<String, dynamic> json) {
    result =
...
class Periods {
  ...
  Periods.fromJson(Map<String, dynamic> json) {
    close = json['close'] != null ? new Closes.fromJson(json['close']) : null;
    open = json['open'] != null ? new Closes.fromJson(json['open']) : null;
  }
...
class Closes {
  ...
  Closes({this.day, this.time});

  Closes.fromJson(Map<String, dynamic> json) {
    day = json['day'];
    time = json['time'];
  }
