...
class HistoryDDesignUI extends StatefulWidget {

  TripsHistoryModelD? tripHistoryInformation;

  HistoryDDesignUI({this.tripHistoryInformation});

  @override
  State<HistoryDDesignUI> createState() => _HistoryDDesignUIState();
}

class _HistoryDDesignUIState extends State<HistoryDDesignUI> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    "Usuario: " + widget.tripHistoryInformation!.userName!,
                    style: TextStyle(
                        fontSize: 16
                    ),
                  ),
            ...
            Row(
              children: [
                ...
                Text(
                  widget.tripHistoryInformation!.userPhone!,
                  style: const TextStyle(
                      fontSize: 16,
